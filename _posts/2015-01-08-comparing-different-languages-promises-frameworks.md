...
C# 5.0 & VB 11.0 took this one step further with language-level asynchrony using the [`await` keyword](http://msdn.microsoft.com/en-us/library/hh191443), allowing you work with promises the just like you would write synchronous code.  Behind the scenes, the compiler transforms async code into a series of promise callbacks.
